const expData = [
    ...
    },
    {
        ...
        description: 
            <div>
                <p>El departamento de investigación de Intikanchay requería una solución práctica para mostrar proyectos universitarios con la posibilidad de escalar y alcanzar presencia en buscadores.</p>
                <p>Esta revista también necesitaba una interfaz de administración muy intuitiva para el manejo de la web sin complicaciones.</p>
            </div>
    },
    {
        id: 6,
        ...
        description: 
            <div>
                <p>Desarrollo y mantenimiento de código para sitios web de clientes externos usando principalmente tecnologías como HTML, CSS, JavaScript y JQuery.</p>
                <p>Sitios web probados manualmente en varios navegadores y dispositivos móviles para garantizar la compatibilidad y brindar la mejor experiencia para los usuarios.</p>
            </div>
    }
